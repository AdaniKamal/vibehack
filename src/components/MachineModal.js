...
import { PLATFORMS, DIFFICULTIES, OS_TYPES, STATUSES, inputStyle, labelStyle, btnPrimary, btnSecondary, btnSmall } from "../constants";
  ...
  return React.createElement("div", {
    ...
    React.createElement("div", {
      ...
      React.createElement("div", { style: { marginBottom: "14px" } },
        React.createElement("label", { style: labelStyle }, "Machine Name"),
      ...
      // Date
      React.createElement("div", { style: { marginBottom: "14px" } },
        React.createElement("label", { style: labelStyle }, "Date Attempted"),
        React.createElement("input", {
        ...
        [["User Flag", "userFlag"], ["Root Flag", "rootFlag"]].map(([label, key]) =>
          React.createElement("label", {
            ...
            style: {
              ...
              color: form[key] ? "#00ff9d" : "#666", fontFamily: "monospace", fontSize: "12px"
            }
          },
            React.createElement("input", {
      ...
      React.createElement("div", { style: { marginBottom: "20px" } },
        React.createElement("label", { style: labelStyle }, "Notes / Write-up"),
